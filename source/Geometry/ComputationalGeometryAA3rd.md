...
- 变量 $i$，值从3到N，依次遍历加入序列 $L_1$，每次加入点 $p_i$，检查最后三个点是否组成**“右转”**的折线段。如果是，继续遍历下一个值，否则删除当前序列 $L_1$ 的倒数第二个点，并继续检查最后三个点是否组成**“右转”**的折线段，以此类推，直到当前序列 $L_1$ 的最后三个点组成**“右转”**的折线段，才继续遍历下一个 *i* 值。
